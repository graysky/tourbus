...
set :url, "http://www.jambase.com/Shows/Shows.aspx?ArtistID=0&VenueID=0&City=San%20Francisco&State=CA&Zip=&radius=50&StartDate=#{now.month}/#{now.day}/#{now.year}&EndDate=#{month}/28/#{year}&Rec=False&pagenum=1&pasi=1500"
