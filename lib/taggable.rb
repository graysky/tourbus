    ...
    module Taggable #:nodoc:
      ...
      module SingletonMethods
        ...
        def find_tagged_with(options = {}) 
          ...
          o, t, o_pk, o_fk, t_pk, t_fk = table_name, tag_model.table_name, primary_key, taggable_foreign_key, tag_model.primary_key, tag_foreign_key
          jt = tags_join_model ? tags_join_model.table_name : tags_join_table
