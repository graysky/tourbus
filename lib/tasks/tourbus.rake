...
task :create_cron_tasks do
  ...
  cmd = <<END
    ...
    RailsCron.create(:command => "ApacheLogParser.parse_archive('/var/log/lighttpd/archive/rails_access_log.1')", :start => 1.minutes.from_now, :every => 24.hours, :concurrent => false)
END
